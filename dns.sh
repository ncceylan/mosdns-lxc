...
# 安装所需软件
apt install unzip wget curl vim -y
echo "软件安装完成"

# 下载 mosdns
wget https://github.com/IrineSistiana/mosdns/releases/download/v5.2.1/mosdns-linux-amd64.zip
echo "下载 mosdns 完成"
wget https://github.com/ncceylan/mosdns-lxc/archive/refs/tags/mosdns-lxc.zip
...
# 解压 easymosdns
unzip mosdns-lxc.zip
sudo mv mosdns-lxc-mosdns-lxc /etc/mosdns
